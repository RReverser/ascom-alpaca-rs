        ...
        $(
            ...
            pub trait $trait_name $(: $parent_trait_name)? {
                rpc!(@if_parent $($parent_trait_name)? {
                    ...
                    fn handle_action(&mut self, is_mut: bool, action: &str, params: &str) -> $crate::ASCOMResult<$crate::OpaqueResponse>;
                });

                $(
                    $(#[doc = $method_doc])*
                    fn $method_name(& $($mut_self)* $(, $params: $params_ty)?) -> $crate::ASCOMResult$(<$return_type>)? {
